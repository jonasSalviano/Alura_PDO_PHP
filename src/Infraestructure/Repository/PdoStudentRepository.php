...
class PdoStudentRepository implements StudentRepository
{
    ...
    {
        $insertValues = 'INSERT INTO students (name, birth_date) VALUES (:name, :birth_date);';
        $stmt = $this->connection->prepare($insertValues);
    ...
    {
        $update = 'UPDATE students SET name = :name, birth_date = :birth_date WHERE id = :id;';
